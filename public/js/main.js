...
var room = location.href.substr(-4,5);
/**
...
function init() {
    ...
    socket.on('chessReceiveData', state => {
      // console.log('chessReceiveData');
      // console.log(state);
      runChess(state.selectedpiece,state.target);
    })
...
//11
    socket.on('initReceive', socket_id => {
      //2~
        ...
        if(socket_id.room==room){
          console.log('INIT RECEIVE ' + socket_id);
          console.log('init');
          console.log(socket_id)
          addPeer(socket_id.socket_id, false)

          socket.emit('initSend', socket_id.socket_id)
          //3
...
$(document).ready(function() {
  ...
  $('.gamecell').click(function(e) {
    ...
    console.log(target);
    //update current page
    runChess(selectedpiece,target);
    //update game room
    socket.emit('chessSendData', { selectedpiece, target ,room});
...
function runChess(selectedpiece,target){
